...
# Paths
_default_data = Path("/tmp/data") if os.environ.get("VERCEL") else Path(__file__).resolve().parent.parent / "data"
DATA_DIR = Path(os.environ.get("AP_DATA_DIR", _default_data))
